...
export default function MetricCard({ title, value, trend, trendUp, icon }: MetricCardProps) {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-[0px_2px_12px_rgba(0,0,0,0.05)] border border-[#EBEBEB] hover:shadow-[0px_6px_20px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-200">
      <div className="flex items-start justify-between mb-5">
        ...
        {trend && (
          <div className={`flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold ${
            trendUp ? 'bg-[#F0F0F0] text-[#111111]' : 'bg-[#F5F5F5] text-[#6B7280]'
          }`}>
      ...
      <div>
        <h3 className="text-[2rem] font-bold text-[#111111] leading-none mb-2 tracking-tight">{value}</h3>
